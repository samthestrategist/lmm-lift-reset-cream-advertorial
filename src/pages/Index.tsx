...
import {
  ...
  ADV_STORY_P4,
  ADV_OPENING_SCENE,
  ADV_PROBLEM_HEADLINE,
  ADV_PROBLEM_BODY,
  ADV_PROBLEM_BODY_2,
  ADV_PROBLEM_BODY_3,
  ADV_PROBLEM_BODY_4,
  ADV_PROBLEM_BODY_5,
  ADV_PROBLEM_BODY_CLOSE,
  ADV_MECHANISM_HEADLINE,
  ADV_MECHANISM_BODY,
  ADV_MECHANISM_BODY_2,
  ADV_MECHANISM_BODY_3,
  ADV_MECHANISM_BODY_4,
  ADV_MECHANISM_BODY_5,
  ADV_MECHANISM_NAME,
  ADV_PHASE_1_TITLE,
  ADV_PHASE_1_BODY,
  ADV_PHASE_2_TITLE,
...
const Index = () => {
  const phases = [
    { phase: "Phase 1", title: ADV_PHASE_1_TITLE, body: ADV_PHASE_1_BODY },
    { phase: "Phase 2", title: ADV_PHASE_2_TITLE, body: ADV_PHASE_2_BODY },
    { phase: "Phase 3", title: ADV_PHASE_3_TITLE, body: ADV_PHASE_3_BODY },
  ];
      ...
      <div style={{ fontFamily: "'Georgia', serif", background: COLORS.bg, color: COLORS.body, minHeight: "100vh" }}>
        ...
        <article style={{ maxWidth: "740px", margin: "0 auto", padding: "0 24px 80px" }}>
          ...
          <p style={{ fontSize: "17px", lineHeight: 1.9, marginBottom: "40px" }}>
            {ADV_MECHANISM_BODY_5} <strong>{ADV_MECHANISM_NAME}</strong>.
          </p>
